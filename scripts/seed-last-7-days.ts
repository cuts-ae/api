...
async function seedLastSevenDays() {
  ...
  try {
    ...
    const healthyBitesItems = [
      { id: 'a1000012-0000-0000-0000-000000000012', price: 62.00 },
      { id: 'a1000004-0000-0000-0000-000000000004', price: 32.00 },
      { id: 'a1000002-0000-0000-0000-000000000002', price: 28.00 },
      { id: 'a1000005-0000-0000-0000-000000000005', price: 48.00 },
      { id: 'a1000009-0000-0000-0000-000000000009', price: 72.00 },
      { id: 'a1000011-0000-0000-0000-000000000011', price: 52.00 },
      { id: 'a1000010-0000-0000-0000-000000000010', price: 55.00 },
      { id: 'a1000007-0000-0000-0000-000000000007', price: 38.00 },
      { id: 'a1000001-0000-0000-0000-000000000001', price: 42.00 },
      { id: 'a1000003-0000-0000-0000-000000000003', price: 35.00 },
      { id: 'a1000006-0000-0000-0000-000000000006', price: 52.00 },
      { id: 'a1000008-0000-0000-0000-000000000008', price: 58.00 },
    ];

    const proteinPalaceItems = [
      { id: 'b2000003-0000-0000-0000-000000000003', price: 65.00 },
      { id: 'b2000008-0000-0000-0000-000000000008', price: 58.00 },
      { id: 'b2000006-0000-0000-0000-000000000006', price: 85.00 },
      { id: 'b2000002-0000-0000-0000-000000000002', price: 35.00 },
      { id: 'b2000004-0000-0000-0000-000000000004', price: 58.00 },
      { id: 'b2000001-0000-0000-0000-000000000001', price: 45.00 },
      { id: 'b2000007-0000-0000-0000-000000000007', price: 55.00 },
      { id: 'b2000005-0000-0000-0000-000000000005', price: 52.00 },
    ];
